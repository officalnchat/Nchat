...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    ...
    chatController = ChatController(receiverId: widget.receiverId);
    listenIncomingCall();
  }
  ...
  Future<void> listenIncomingCall() async {
    final myId = await firestoreService.getCurrentUserId();

    callSubscription = firestoreService.listenIncomingCall(myId).listen((
      snapshot,
    ) async {
      ...
      await firestoreService.setCallRinging(callId: callId);
                ...
                builder: (context, snapshot) {
                  ...
                  if (snapshot.hasData && snapshot.data!.exists) {
                    ...
                    if (typing) {
                      ...
                      status = chatController.formatLastSeen(data["lastSeen"]);
                    }
                  }
  ...
  onPressed: () async {
    ...
    final callId = chatController.currentCallId;

    print("📞 Caller CallScreen CallId: $callId");

    if (!mounted) return;

    if (callId == null || callId.isEmpty) {
      print("❌ Cannot open CallScreen: CallId is null");
      return;
    }
        ...
        children: [
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                chatController.loadMessages(snapshot.data!);
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final message = chatController.filteredMessages[index];
                    return MessageBubble(
                      ...
                      onLongPress: () async {
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  ListTile(
                                    ...
                                    onTap: () {
                                      Navigator.pop(context, "deleteForMe");
                                    },
                                  ),
                        ...
                        if (action == "delete") {
                          await chatController.deleteMessage(message["docId"]);
                        }
                      },
                    );
                  },
          ...
          ChatInputBar(
            ...
            onTypingChanged: (typing) async {
              await chatController.setTyping(typing);
            },

            onSend: () {
              chatController.sendMessage(context, refresh);
            },

            onImageTap: () {
              chatController.sendImage(context, refresh);
            },
            ...
            onMicLongPressEnd: () async {
              final path = await chatController.stopRecording();

              print("🎵 Audio Saved: $path");

              await chatController.sendVoiceMessage(context, refresh);
            },
          ),
        ],
      ),
  ...
  Widget _reactionButton(BuildContext context, String emoji) {
    return InkWell(
      onTap: () {
